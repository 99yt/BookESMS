...
<div id="bodyPart">
	...
	<div class="List_cart">
		...
		<div class="cart_table">
			...
			<div class="tip_5">
				<p>
					您的订单号：<strong>${orderId}</strong>&nbsp;&nbsp;&nbsp;&nbsp;
					应付金额：<strong>${totalPrice}</strong>元&nbsp;&nbsp;&nbsp;&nbsp;
					支付方式：在线支付&nbsp;&nbsp;&nbsp;&nbsp;
					配送方式：京东快递&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="tip_6">
				...
				<span style="margin-left: 90px;"><a target="_blank" href="orderInfo.jsp?orderId=${orderId}">查看订单状态</a></span>&nbsp;&nbsp;<a target="_blank" href="#">查看银行限额帮助</a>
			</div>
			...
			<div class="tip_4">
				完成支付后，您可以：<a  href="orderInfo.jsp">查看订单状态</a>&nbsp;&nbsp;&nbsp;<a  href="book.jsp">继续购物</a>
				&nbsp;&nbsp;&nbsp;<a  href="#">问题反馈</a>
