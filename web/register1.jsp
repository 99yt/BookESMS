...
<script type="text/javascript">
   $(function () {
       $("#form").submit(function () {
           ...
           if($("#username").val()==""||$("#pwd").val()==""||$("#pwdConfirm").val()==""||$("#email").val()==""||$("#references").val()==""){
                 $("#feedback").html("有信息为空！！！");
                 return false;
           }else {
               $("#feedback").html("");
           ...
           var reg=new RegExp("/^[a-zA-Z0-9]+([-_.][a-zA-Z0-9]+)*@[a-zA-Z0-9]+([-_.][a-zA-Z0-9]+)*\.[a-z]{2,}$/");
...
<div id="bodyPart">
    ...
    <div id="register">
        ...
        <div class="register_content">
            <div class="clear"></div>
           <form id="form" action="/bookstore/userControl?type=register" method="post">
           	<div class="user_form"> 
                <div class="uInfo">
                ...
                <div class="uInfo">
                    ...
                    <input type="password" class="text"  name="pwdConfirm" id="pwdConfirm"/>
                    <span id="s3"></span>
                </div>
                <div class="uInfo">
                ...
                <div class="uInfo">
                    ...
                    <input type="text" class="text" name="references" id="references"/>
                    <span id="s5"></span>
                </div>
                <div class="uInfo">
                ...
                <div class="uInfo">
                    ...
                    <input type="submit" id="button" value="同意以下协议，提交"/><span id="feedback"></span>
                </div>
            </div>     
            </form>
