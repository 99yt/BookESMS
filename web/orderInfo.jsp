...
<div id="bodyPart">
    <div class="w">
        <div class="crumb">
            <a href="index.jsp">首页</a> &nbsp;&gt;&nbsp; <a href="#">我的京东</a>
            &nbsp;&gt;&nbsp; <a href="#">订单中心</a> &nbsp;&gt;&nbsp; <a href="#">订单：{{order.orderId}}</a>
        </div>
    </div>
    <!--主体-->
    <div class="main">
        <div id="order_info">
            <div class="order_state">
                <div class="opr_order">
                    <strong>订单号：{{order.orderId}}&nbsp;&nbsp; 状态：<span>{{order.status=='0'?'等待':'完成'}}</span></strong>
                    <div class="state_btn">
                        <ul>
                            <li><a href="#">支付</a></li>
                            <li><a href="#">修改</a></li>
                ...
                <div class="clear"></div>
                <p>
                    尊敬的客户，我们还未收到该订单的款项，请您尽快付款（<a href="#">查看邮局汇款信息</a>），如果您已经付款，请务必填写<a
                        href="#">付款确认</a>。<br />
            ...
            <div id="process_chart">
                ...
                <div class="dl_text">
                    <ul>
                        <li>&nbsp;提交订单<br /> <span>{{order.orderTime}}<span></li>
                        <li>等待付款</li>
            ...
            <div id="order_text">
                ...
                <div id="order_text_1">
                    ...
                    <div id="order_list">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr class="tr_2" v-for="p of order.products">
                                <td>{{p.productId}}</td>
                                <td align="left"><a
                                        :href="'bookDetail.jsp?productId='+p.product_id">&nbsp;{{p.name}}</a></td>
                ...
                <div class="order_total">
                    <ul>
                        <li>商品总金额：￥{{order.totalPrice}}</li>
                        <li>+ 运费：￥0.00</li>
                        <li>- 优惠：￥0.00</li>
                        <li>- 余额：￥0.00</li>
                    </ul>
                    <div class="m_total">
                        <b>订单支付金额：<span>￥{{order.totalPrice}}</span></b>
                    </div>
                </div>
            </div>
